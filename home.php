...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img src="images/mangoes icon.png" alt="">
         </div>
         <div class="content">
...
<section class="category">
   ...
   <a href="category.php?category=vegetables" class="swiper-slide slide">
      <img src="images/vegetable icon.png" alt="">
      <h3>vegetables</h3>
   </a>
   ...
   <a href="category.php?category=dairy" class="swiper-slide slide">
      <img src="images/dairy icon.png" alt="">
      <h3>dairy</h3>
   </a>

   <a href="category.php?category=grains" class="swiper-slide slide">
      <img src="images/grain.jpg" alt="">
      <h3>grains</h3>
   </a>

   <a href="category.php?category=spices" class="swiper-slide slide">
